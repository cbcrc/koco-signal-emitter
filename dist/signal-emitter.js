(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'signals'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('signals'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.signals);
        global.signalEmitter = mod.exports;
    }
})(this, function (exports, _signals) {
    'use strict';
